...
export default function PuntoDeVenta() {
  ...
  async function fetchPendientes() {
    const { data } = await supabase
      ...
      .select(`
        *,
        products(id, name, price, image_url, stock, stock_ilimitado),
  ...
  async function confirmOrder(orderToConfirm) {
    ...
    // 2. Descontar stock si no es ilimitado
    ...
    setSuccess(`✅ ¡Orden confirmada! Entrega registrada correctamente.`)
    setOrder(null)
    setOrderId('')
    fetchPendientes()
    setLoading(false)
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">Escanea el QR del comprador o busca la orden manualmente</p>
        </div>
